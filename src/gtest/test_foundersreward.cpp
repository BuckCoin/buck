...
void verifyNumberOfRewards() {
    ...
    EXPECT_EQ(ms[params.GetFoundersRewardAddressAtIndex(0)], 17708);
    for (int i = 2; i <= 46; i++) {
        EXPECT_EQ(ms[params.GetFoundersRewardAddressAtIndex(i)], 17709);
    }
    EXPECT_EQ(ms[params.GetFoundersRewardAddressAtIndex(47)], 17677);
}
