...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("Buck Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n" + PrivacyInfo();
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  zcashd [options]                     " + _("Start Buck Daemon") + "\n";
    ...
    try
    {
        ...
        try
        {
            ...
            fprintf(stderr,
                ...
                "/usr/share/doc/zcash/examples/buck.conf");
            return false;
        ...
        if (fDaemon)
        {
            fprintf(stdout, "Buck server starting\n");
